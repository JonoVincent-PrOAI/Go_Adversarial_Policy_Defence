...
class Kata_Adv_GTP_Subprocess():

    def __init__(self, model_name: str, model_path, victim_model_path, config_path):
        
        self.model_name = model_name
        command = '../../engines/KataGo-custom/cpp/katago'
        subcommand = 'gtp'
        model_arg = '-model ' + model_path
        vic_model_arg = '-victim-model ' + victim_model_path
        config_arg = '-config ' + config_path

        self.full_command = [command, subcommand, model_arg, vic_model_arg, config_arg]
